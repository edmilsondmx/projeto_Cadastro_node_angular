...
import validacaoCamposAlterarEndereço from './ValidacaoCamposAlterarEndereco';
...
export default function validacaoCamposAlterarPessoa(
  request: Request,
  response: Response,
  next: NextFunction,
) {
  ...
  if (enderecos.length === 0) {
    throw new ValidacaoErro(
      'Ao menos um endereço deve permanecer no cadastro!',
      400,
      'enderecos',
    );
  }
  ...
  validacaoCamposAlterarEndereço(enderecos);
